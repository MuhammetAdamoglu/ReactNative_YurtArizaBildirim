...
export default class ChangePassword extends Component<Props> {
    ...
    change(){
        ...
        if(props.errPassword_change && props.errPassword_new && props.errPasswordAgain_new){ //İnputlarda sorun yok ise
            //verileri ajaxa gönderir
            ajax.changePassword(this,this.state.password_change,this.state.password_new,"");
        }
    }
