...
type Props = {};
export default class getMalfunctions_Panel extends Component<Props> {
    ...
    Complate(i){
        ...
        if(list[i]["complated"]==="hayir"){//tamamlanmamış ise
            ...
            status=props.userData ["meslek"];
            ajax.complate(this,list[i]["id"],props.userData ["meslek"],status,i,"");
        }
    }
